...
namespace Seepossible\Demo\Controller\Adminhtml;
...
abstract class Items extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $this->_setActiveMenu('Seepossible_Demo::items')->_addBreadcrumb(__('Blog'), __('Blog'));
        return $this;
    }
    ...
    {
        return $this->_authorization->isAllowed('Seepossible_Demo::items');
    }*/
}